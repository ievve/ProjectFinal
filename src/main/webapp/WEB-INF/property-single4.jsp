			...
			<div class="container">
				...
				<div class="row" style="margin-bottom:5%">
					...
					<div class="col-md-4 mt-lg-5" data-aos="fade-up" data-aos-delay="100">
						<img src="https://search.pstatic.net/common/?src=http%3A%2F%2Fblogfiles.naver.net%2F20140409_15%2Flalamin1_1397020546699sMXdS_JPEG%2F00000_140404_080949_991b.jpg&type=sc960_832" alt="Image" class="img-fluid">
					</div>
					<div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
						<img src="https://search.pstatic.net/common/?src=http%3A%2F%2Fblogfiles.naver.net%2FMjAyMTExMjdfODQg%2FMDAxNjM3OTQwNTgxNDM1.4GfKKjvU7UTYWg0w6CupcQLLdQKb_eIn-JkwfmXTG34g.LiIoueWPwKoz4dyCepNGlfwD7FjHC8CUhTxqYVh_H5kg.JPEG.allaboutkg%2FBandPhoto%25A3%25DF2021%25A3%25DF11%25A3%25DF27%25A3%25DF00%25A3%25DF28%25A3%25DF15.jpg&type=sc960_832" alt="Image" class="img-fluid">
					</div>
				</div>
				...
				<script>
					var staticMapContainer = document.getElementById('map'), // 이미지 지도를 표시할 div 
						staticMapOption = {
							marker: {
								text: '', // 마커와 함께 표시할 텍스트
								position: new kakao.maps.LatLng(37.590271, 126.967697) // 좌표가 없으면 지도 중심에 마커가 표시된다
							},
		...
		var api = new Vue({
			...
			methods: {
				search: function () {
					...
					queryParams += '&' + encodeURIComponent('pnu') + '=' + encodeURIComponent('1111017400100140004'); /**/
